...
Open your browser and go to `http://localhost:5002` to see the welcome message.

Test the Visit Count:
Navigate to `http://localhost:5002/count` to see the visit count increment each time you refresh the page.